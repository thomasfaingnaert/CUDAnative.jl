...
function NVPA_GetProcAddress(pFunctionName)
    ccall((:NVPA_GetProcAddress, libnvperf), NVPA_GenericFn,
          (Cstring,),
          pFunctionName)
end

function NVPW_SetLibraryLoadPaths(pParams)
    @check ccall((:NVPW_SetLibraryLoadPaths, libnvperf), NVPA_Status,
                 (Ptr{NVPW_SetLibraryLoadPaths_Params},),
                 pParams)
end

function NVPW_SetLibraryLoadPathsW(pParams)
    @check ccall((:NVPW_SetLibraryLoadPathsW, libnvperf), NVPA_Status,
                 (Ptr{NVPW_SetLibraryLoadPathsW_Params},),
                 pParams)
end

function NVPA_InitializeHost()
    @check ccall((:NVPA_InitializeHost, libnvperf), NVPA_Status, ())
end

function NVPW_InitializeHost(pParams)
    @check ccall((:NVPW_InitializeHost, libnvperf), NVPA_Status,
...
function NVPA_CounterData_CalculateCounterDataImageCopySize(pCounterDataImageCopyOptions,
    ...
    @check ccall((:NVPA_CounterData_CalculateCounterDataImageCopySize, libnvperf), NVPA_Status,
...
function NVPW_CounterData_CalculateCounterDataImageCopySize(pParams)
    @check ccall((:NVPW_CounterData_CalculateCounterDataImageCopySize, libnvperf), NVPA_Status,
...
function NVPA_CounterData_InitializeCounterDataImageCopy(pCounterDataImageCopyOptions,
    ...
    @check ccall((:NVPA_CounterData_InitializeCounterDataImageCopy, libnvperf), NVPA_Status,
...
function NVPW_CounterData_InitializeCounterDataImageCopy(pParams)
    @check ccall((:NVPW_CounterData_InitializeCounterDataImageCopy, libnvperf), NVPA_Status,
...
function NVPA_CounterDataCombiner_Create(pCounterDataCombinerOptions, ppCounterDataCombiner)
    @check ccall((:NVPA_CounterDataCombiner_Create, libnvperf), NVPA_Status,
...
function NVPA_CounterDataCombiner_CreateRange(pCounterDataCombiner, numDescriptions,
    ...
    @check ccall((:NVPA_CounterDataCombiner_CreateRange, libnvperf), NVPA_Status,
...
function NVPW_CounterDataCombiner_CreateRange(pParams)
    @check ccall((:NVPW_CounterDataCombiner_CreateRange, libnvperf), NVPA_Status,
...
function NVPA_CounterDataCombiner_AccumulateIntoRange(pCounterDataCombiner, rangeIndexDst,
    ...
    @check ccall((:NVPA_CounterDataCombiner_AccumulateIntoRange, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_Destroy(pRawMetricsConfig)
    @check ccall((:NVPA_RawMetricsConfig_Destroy, libnvperf), NVPA_Status,
                 (Ptr{NVPA_RawMetricsConfig},),
                 pRawMetricsConfig)
end

function NVPW_RawMetricsConfig_Destroy(pParams)
    @check ccall((:NVPW_RawMetricsConfig_Destroy, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_BeginPassGroup(pRawMetricsConfig, pRawMetricsPassGroupOptions)
    @check ccall((:NVPA_RawMetricsConfig_BeginPassGroup, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_GetMetricProperties(pRawMetricsConfig, metricIndex,
    ...
    @check ccall((:NVPA_RawMetricsConfig_GetMetricProperties, libnvperf), NVPA_Status,
...
function NVPW_RawMetricsConfig_GetMetricProperties(pParams)
    @check ccall((:NVPW_RawMetricsConfig_GetMetricProperties, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_AddMetrics(pRawMetricsConfig, pRawMetricRequests,
                                          numMetricRequests)
    @check ccall((:NVPA_RawMetricsConfig_AddMetrics, libnvperf), NVPA_Status,
...
function NVPW_RawMetricsConfig_AddMetrics(pParams)
    @check ccall((:NVPW_RawMetricsConfig_AddMetrics, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_IsAddMetricsPossible(pRawMetricsConfig, pRawMetricRequests,
    ...
    @check ccall((:NVPA_RawMetricsConfig_IsAddMetricsPossible, libnvperf), NVPA_Status,
                 (Ptr{NVPA_RawMetricsConfig}, Ptr{NVPA_RawMetricRequest}, Csize_t,
                  Ptr{NVPA_Bool}),
...
function NVPW_RawMetricsConfig_IsAddMetricsPossible(pParams)
    @check ccall((:NVPW_RawMetricsConfig_IsAddMetricsPossible, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_GenerateConfigImage(pRawMetricsConfig)
    @check ccall((:NVPA_RawMetricsConfig_GenerateConfigImage, libnvperf), NVPA_Status,
                 (Ptr{NVPA_RawMetricsConfig},),
                 pRawMetricsConfig)
end

function NVPW_RawMetricsConfig_GenerateConfigImage(pParams)
    @check ccall((:NVPW_RawMetricsConfig_GenerateConfigImage, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_GetConfigImage(pRawMetricsConfig, bufferSize, pBuffer,
                                              pBufferSize)
    @check ccall((:NVPA_RawMetricsConfig_GetConfigImage, libnvperf), NVPA_Status,
...
function NVPW_RawMetricsConfig_GetConfigImage(pParams)
    @check ccall((:NVPW_RawMetricsConfig_GetConfigImage, libnvperf), NVPA_Status,
...
function NVPA_RawMetricsConfig_GetNumPasses(pRawMetricsConfig, pNumPipelinedPasses,
                                            pNumIsolatedPasses)
    @check ccall((:NVPA_RawMetricsConfig_GetNumPasses, libnvperf), NVPA_Status,
...
function NVPW_RawMetricsConfig_GetNumPasses(pParams)
    @check ccall((:NVPW_RawMetricsConfig_GetNumPasses, libnvperf), NVPA_Status,
                 (Ptr{NVPW_RawMetricsConfig_GetNumPasses_Params},),
                 pParams)
end

function NVPA_CounterDataBuilder_Create(pOptions, ppCounterDataBuilder)
    @check ccall((:NVPA_CounterDataBuilder_Create, libnvperf), NVPA_Status,
...
function NVPW_CounterDataBuilder_Create(pParams)
    @check ccall((:NVPW_CounterDataBuilder_Create, libnvperf), NVPA_Status,
                 (Ptr{NVPW_CounterDataBuilder_Create_Params},),
                 pParams)
end

function NVPA_CounterDataBuilder_Destroy(pCounterDataBuilder)
    @check ccall((:NVPA_CounterDataBuilder_Destroy, libnvperf), NVPA_Status,
                 (Ptr{NVPA_CounterDataBuilder},),
                 pCounterDataBuilder)
end

function NVPW_CounterDataBuilder_Destroy(pParams)
    @check ccall((:NVPW_CounterDataBuilder_Destroy, libnvperf), NVPA_Status,
...
function NVPA_CounterDataBuilder_AddMetrics(pCounterDataBuilder, pRawMetricRequests,
                                            numMetricRequests)
    @check ccall((:NVPA_CounterDataBuilder_AddMetrics, libnvperf), NVPA_Status,
...
function NVPW_CounterDataBuilder_AddMetrics(pParams)
    @check ccall((:NVPW_CounterDataBuilder_AddMetrics, libnvperf), NVPA_Status,
...
function NVPA_CounterDataBuilder_GetCounterDataPrefix(pCounterDataBuilder, bufferSize,
                                                      pBuffer, pBufferSize)
    @check ccall((:NVPA_CounterDataBuilder_GetCounterDataPrefix, libnvperf), NVPA_Status,
...
function NVPW_CounterDataBuilder_GetCounterDataPrefix(pParams)
    @check ccall((:NVPW_CounterDataBuilder_GetCounterDataPrefix, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_Create(pMetricsContextOptions, ppMetricsContext)
    @check ccall((:NVPA_MetricsContext_Create, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_Destroy(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_Destroy, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_Destroy(pParams)
    @check ccall((:NVPW_MetricsContext_Destroy, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_Destroy_Params},),
                 pParams)
end

function NVPA_MetricsContext_RunScript(pMetricsContext, pOptions)
    @check ccall((:NVPA_MetricsContext_RunScript, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetCounterNames_Begin(pMetricsContext, pNumCounters,
                                                   pppCounterNames)
    @check ccall((:NVPA_MetricsContext_GetCounterNames_Begin, libnvperf), NVPA_Status,
...
function NVPW_MetricsContext_GetCounterNames_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetCounterNames_Begin, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_GetCounterNames_Begin_Params},),
                 pParams)
end

function NVPA_MetricsContext_GetCounterNames_End(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_GetCounterNames_End, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_GetCounterNames_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetCounterNames_End, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetThroughputNames_Begin(pMetricsContext, pNumThroughputs,
                                                      pppThroughputName)
    @check ccall((:NVPA_MetricsContext_GetThroughputNames_Begin, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext}, Ptr{Csize_t}, Ptr{Ptr{Cstring}}),
                 pMetricsContext, pNumThroughputs, pppThroughputName)
end

function NVPW_MetricsContext_GetThroughputNames_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetThroughputNames_Begin, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetThroughputNames_End(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_GetThroughputNames_End, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_GetThroughputNames_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetThroughputNames_End, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_GetThroughputNames_End_Params},),
                 pParams)
end

function NVPW_MetricsContext_GetRatioNames_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetRatioNames_Begin, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_GetRatioNames_Begin_Params},),
                 pParams)
end

function NVPW_MetricsContext_GetRatioNames_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetRatioNames_End, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetMetricNames_Begin(pMetricsContext, pOptions)
    @check ccall((:NVPA_MetricsContext_GetMetricNames_Begin, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext}, Ptr{NVPA_MetricsEnumerationOptions}),
                 pMetricsContext, pOptions)
end

function NVPW_MetricsContext_GetMetricNames_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetMetricNames_Begin, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_GetMetricNames_Begin_Params},),
                 pParams)
end

function NVPA_MetricsContext_GetMetricNames_End(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_GetMetricNames_End, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_GetMetricNames_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetMetricNames_End, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetThroughputBreakdown_Begin(pMetricsContext, pThroughputName,
    ...
    @check ccall((:NVPA_MetricsContext_GetThroughputBreakdown_Begin, libnvperf), NVPA_Status,
...
function NVPW_MetricsContext_GetThroughputBreakdown_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetThroughputBreakdown_Begin, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetThroughputBreakdown_End(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_GetThroughputBreakdown_End, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_GetThroughputBreakdown_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetThroughputBreakdown_End, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetMetricProperties_Begin(pMetricsContext, pMetricName,
                                                       pMetricProperties)
    @check ccall((:NVPA_MetricsContext_GetMetricProperties_Begin, libnvperf), NVPA_Status,
...
function NVPW_MetricsContext_GetMetricProperties_Begin(pParams)
    @check ccall((:NVPW_MetricsContext_GetMetricProperties_Begin, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_GetMetricProperties_End(pMetricsContext)
    @check ccall((:NVPA_MetricsContext_GetMetricProperties_End, libnvperf), NVPA_Status,
                 (Ptr{NVPA_MetricsContext},),
                 pMetricsContext)
end

function NVPW_MetricsContext_GetMetricProperties_End(pParams)
    @check ccall((:NVPW_MetricsContext_GetMetricProperties_End, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_SetCounterData(pMetricsContext, pCounterDataImage, rangeIndex,
                                            isolated)
    @check ccall((:NVPA_MetricsContext_SetCounterData, libnvperf), NVPA_Status,
...
function NVPW_MetricsContext_SetCounterData(pParams)
    @check ccall((:NVPW_MetricsContext_SetCounterData, libnvperf), NVPA_Status,
                 (Ptr{NVPW_MetricsContext_SetCounterData_Params},),
                 pParams)
end

function NVPA_MetricsContext_SetUserData(pMetricsContext, pMetricUserData)
    @check ccall((:NVPA_MetricsContext_SetUserData, libnvperf), NVPA_Status,
...
function NVPW_MetricsContext_SetUserData(pParams)
    @check ccall((:NVPW_MetricsContext_SetUserData, libnvperf), NVPA_Status,
...
function NVPA_MetricsContext_EvaluateToGpuValues(pMetricsContext, numMetrics,
    ...
    @check ccall((:NVPA_MetricsContext_EvaluateToGpuValues, libnvperf), NVPA_Status,
