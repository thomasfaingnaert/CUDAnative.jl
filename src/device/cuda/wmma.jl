...
wmma_load_b(src_addr, stride) =
    Base.llvmcall((
    """
    declare { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.load.b.sync.row.m16n16k16.stride.f16(i8*, i32)
    """,
    """
    %src_ptr = inttoptr i64 %0 to i8*

    %ret = call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.load.b.sync.row.m16n16k16.stride.f16(i8* %src_ptr, i32 %1)
